        ...
        <div class="container py-4 py-md-5 px-4 px-md-3 text-body-secondary">
            <div class="row">
                ...
                <div class="col-6 col-lg-2 offset-lg-1 mb-3">
                    ...
                    <li class="mb-2"><a href="#">Overview</a></li>
                    <li class="mb-2"><a href="#">Data Klub</a></li>
                    <li class="mb-2"><a href="#">Skors</a></li>
                    <li class="mb-2"><a href="https://adee-wahyudi.github.io/">Portfolio</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2 mb-3">
                    <h5>Social Media</h5>
                    <ul class="list-unstyled">
                    <li class="mb-2"><a href="https://github.com/adee-wahyudi">Github</a></li>
                    <li class="mb-2"><a href="https://www.instagram.com/adee_wahyudi/">Instagram</a></li>
                    <li class="mb-2"><a href="https://www.youtube.com/@yudicoding">Youtube</a></li>
                    <li class="mb-2"><a href="https://id.linkedin.com/in/adee-wahyudi-1696971bb">Linkedin</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2 mb-3">
                    <h5>Components</h5>
